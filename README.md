...
curl -v 'http://localhost:8080/raw/apache/dist/nifi/2.9.0/minifi-2.9.0-bin.zip.asc' > /dev/null

curl -v 'http://localhost:8080/raw/apache/dist/nifi/2.9.0/minifi-2.9.0-bin.zip' > /dev/null
