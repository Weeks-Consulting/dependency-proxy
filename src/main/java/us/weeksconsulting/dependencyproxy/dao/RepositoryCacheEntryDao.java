...
public class RepositoryCacheEntryDao {
    ...
    public RepositoryCacheEntry getCacheEntry(String repositoryType, String repositoryName,
            String urlPath, Map<String, String> urlParams) {
        ...
        return this.jdbcClient.sql("""
                ...
                .param("repository_name", repositoryName).param("url_path", urlPath)
                .param("url_params", serializeUrlParams(urlParams))
                .query(RepositoryCacheEntry.class).optional().orElse(null);
    }
    ...
    public RepositoryCacheEntry getCacheEntry(String cacheObjectId) {
        ...
        return this.jdbcClient.sql("""
                ...
                """).param("cache_object_id", cacheObjectId).query(RepositoryCacheEntry.class)
    ...
    public RepositoryCacheEntry insertGetCacheEntry(String repositoryType, String repositoryName,
        ...
        return this.jdbcClient.sql("""
                ...
                """).param("repository_type", repositoryType)
                .param("repository_name", repositoryName).param("url_path", urlPath)
                .param("url_params", serializeUrlParams(urlParams)).param("mime_type", mime_type)
                .param("cache_object_path",
                        getObjectFilePath(urlPath, serializeUrlParams(urlParams)))
                .param("cache_object_id", UUID.randomUUID()).param("is_cached", false)
                .param("inserted_at", Timestamp.from(Instant.now()))
                .param("updated_at", Timestamp.from(Instant.now()))
                .query(RepositoryCacheEntry.class).optional()
    ...
    public void updateCacheEntry(UUID cacheObjectId, boolean isCached) {
        ...
        this.jdbcClient.sql("""
                ...
                where cache_object_id = :cache_object_id
                """).param("cache_object_id", cacheObjectId).param("is_cached", isCached).update();
    }
