package us.weeksconsulting.dependencyproxy.util;
 ...
 * @since 1.4
 */
public class BetterTeeInputStream extends ProxyInputStream {
   ...
   */
  public BetterTeeInputStream(final InputStream input, final OutputStream branch) {
